...
- [Install Ory CLI](../../guides/cli/installation) - a tool that will help you connect the app running on your machine to Ory
  Network APIs.
...
edit your project's [Identity Schema](../manage-identities/identity-schema) or try changing adjusting project settings and enable
[passwordless](../passwordless/webauthn) flows.
...
To learn more about the self-service login flow, read [this document](../self-service/flows/user-login)
