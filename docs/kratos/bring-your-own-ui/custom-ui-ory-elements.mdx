...
edit your project's [Identity Schema](../manage-identities/identity-schema) or try changing adjusting project settings and
enable [passwordless](../passwordless/webauthn) flows.
